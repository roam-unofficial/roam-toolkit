 ...
 */
export class RoamHighlight {
    static firstBlockElement(): BlockElement {
        return assumeExists(highlightedBlocks()[0], 'No block is highlighted')
    }

    static lastBlockElement(): BlockElement {
